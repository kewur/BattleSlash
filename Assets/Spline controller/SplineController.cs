...
public class SplineController : MonoBehaviour
{
	...
	public void OnDrawGizmos()
	{
		...
		SetupSplineInterpolator(interp, trans, true);
		...
		for (int c = 1; c <= 100; c++)
		{
			...
			Gizmos.color = new Color(mag, 0, 0.5f, 1);
	...
	public void SetupSplineInterpolator(SplineInterpolator interp, Transform[] trans, bool reset)
	{
		if(reset)
			interp.Reset();
	...
	public void FollowSpline()
	{
		...
		{
			SetupSplineInterpolator(mSplineInterp, mTransforms, true);
